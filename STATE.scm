...
(define metadata
  '((version . "0.1.0")
    ...
    (repo . "github.com/hyperpolymath/asdf-acceleration-middleware")))
...
(define project-context
  '((name . "asdf-acceleration-middleware")
    (tagline . "*High-performance middleware and tooling ecosystem for accelerating [asdf](https://asdf-vm.com/) runtime operations.*")
    (version . "0.1.0")
